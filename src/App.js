...
class App extends Component {
  ...
  matchingImageId = id => {
    ...
    const isImageMatch = imagesList[randomImage].id === id

    console.log(imagesList[randomImage].id)
    console.log(id)
    ...
    if (isImageMatch) {
      ...
      this.setState({mainImageUrl: imagesList[randomImage].imageUrl})
    } else {
      this.setState({isGameInProgress: false})
      clearInterval(this.timeInterval)
  ...
  render() {
    const {clickedCardList, timer, isGameInProgress} = this.state
